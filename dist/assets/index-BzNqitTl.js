(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const a of r)if(a.type==="childList")for(const c of a.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&i(c)}).observe(document,{childList:!0,subtree:!0});function o(r){const a={};return r.integrity&&(a.integrity=r.integrity),r.referrerPolicy&&(a.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?a.credentials="include":r.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function i(r){if(r.ep)return;r.ep=!0;const a=o(r);fetch(r.href,a)}})();/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const g=([e,t,o])=>{const i=document.createElementNS("http://www.w3.org/2000/svg",e);return Object.keys(t).forEach(r=>{i.setAttribute(r,String(t[r]))}),o!=null&&o.length&&o.forEach(r=>{const a=g(r);i.appendChild(a)}),i},A=(e,t={})=>{const i={...f,...t};return g(["svg",i,e])};/**
 * @license lucide v1.7.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const C=(...e)=>e.filter((t,o,i)=>!!t&&t.trim()!==""&&i.indexOf(t)===o).join(" ").trim();/**
 * @license lucide v1.7.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const H=e=>e.replace(/^([A-Z])|[\s-_]+(\w)/g,(t,o,i)=>i?i.toUpperCase():o.toLowerCase());/**
 * @license lucide v1.7.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const $=e=>Array.from(e.attributes).reduce((t,o)=>(t[o.name]=o.value,t),{}),h=e=>typeof e=="string"?e:!e||!e.class?"":e.class&&typeof e.class=="string"?e.class.split(" "):e.class&&Array.isArray(e.class)?e.class:"",u=(e,{nameAttr:t,icons:o,attrs:i})=>{var p;const r=e.getAttribute(t);if(r==null)return;const a=E(r),c=o[a];if(!c)return console.warn(`${e.outerHTML} icon name was not found in the provided icons object.`);const n=$(e),b=L(n)?{}:{"aria-hidden":"true"},l={...f,"data-lucide":r,...b,...i,...n},v=h(n),w=h(i),d=C("lucide",`lucide-${r}`,...v,...w);d&&Object.assign(l,{class:d});const M=A(c,l);return(p=e.parentNode)==null?void 0:p.replaceChild(M,e)};/**
 * @license lucide v1.7.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
`;document.body.append(s);const m=Array.from(document.querySelectorAll(".filter-button")),U=Array.from(document.querySelectorAll(".simple-list li"));m.forEach(e=>{e.addEventListener("click",()=>{const t=e.dataset.filter;m.forEach(o=>{o.classList.toggle("is-active",o===e)}),U.forEach(o=>{const i=t==="전체"||o.dataset.category===t;o.hidden=!i})})});k({icons:{ArrowUpRight:x,BadgeCheck:N,BookOpen:O,BriefcaseBusiness:S,Camera:I,CloudUpload:P,FlaskConical:j,Globe:B,Hammer:V,Library:q,Mic:F,MonitorPlay:T,Plane:z,Search:K},attrs:{width:18,height:18,strokeWidth:2}});
